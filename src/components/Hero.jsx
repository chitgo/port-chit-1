      ...
      <div className="flex flex-col items-center gap-8 md:justify-center md:flex-row-reverse md:text-left  ">
        ...
        <div className="flex flex-col items-center gap-8 md:items-start ">
          ...
          <p className="max-w-xl text-xl text-gray-500 ">
            Hey there, I'm
            <span className="font-bold"> Konstantinos Chitos</span>, a developer
            based in Athens, Greece. I build responsive web and mobile apps with
            React, React Native, and TailwindCSS.
          </p>
