...
function Navbar() {
  ...
  return (
    <section className='sticky top-0 z-10 flex items-center justify-between px-4 mx-auto overflow-hidden bg-white sm:px-8 md:px-12 lg:px-20 2xl:px-40 py-7 text-secondary'>
